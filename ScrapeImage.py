...
#def scrape_image(speciesCodelist):
    
# list of species codes, point to stored location and take slice of column
speciesCode_list ='A:/Documents/Python Scripts/BirdBot2.0/Scraper/_output/species_info.csv'
speciesCodelist = pd.read_csv(speciesCode_list)
speciesCodelist = speciesCodelist['speciesCode']
#speciesCodelist = speciesCode_list
#speciesCodelist = speciesCodelist[4:]

# Creating a directory to save images
for x in speciesCodelist:
    folder_name = x
    path = 'A:\Documents\Python Scripts\BirdBot2.0\Scraper\_images'
    os.chdir(path)
...
dt = timer() - start
minutes = dt / 60
print(f"Scrape image took {minutes} minutes to complete")
